...
-- Mon 16 Dec 2019 04:13:51 AM EST
...
-- -----------------------------------------------------
-- Data for table `secretaria_administrativa`.`usuarios`
-- -----------------------------------------------------
START TRANSACTION;
USE `secretaria_administrativa`;
INSERT INTO `secretaria_administrativa`.`usuarios` (`idusuarios`, `nombre`, `apellido`, `cedula`, `direccion`, `correo_electronico`, `password`, `telefono`, `idRoles`) VALUES (DEFAULT, 'Marisol', 'Cedeño', '8-420-72', 'Los Pueblos 2000', 'marisol.cedeño@utp.ac.pa', 'M@43CedSol', 2304732, NULL);
INSERT INTO `secretaria_administrativa`.`usuarios` (`idusuarios`, `nombre`, `apellido`, `cedula`, `direccion`, `correo_electronico`, `password`, `telefono`, `idRoles`) VALUES (DEFAULT, 'Claribel', 'Pimentel', '3-692-224', 'Pedregal, El Diamante', 'claribel.pimentel@utp.ac.pa', 'P!mCl@ri8746', 2780059, NULL);
INSERT INTO `secretaria_administrativa`.`usuarios` (`idusuarios`, `nombre`, `apellido`, `cedula`, `direccion`, `correo_electronico`, `password`, `telefono`, `idRoles`) VALUES (DEFAULT, 'Manuel', 'Aguilar', '1-984-6452', 'San Miguelito, Linda Vista', 'manuel.aguilar@utp.ac.pa', '22@nuelAg!L229', 2938722, NULL);
...
-- -----------------------------------------------------
-- Data for table `secretaria_administrativa`.`Materiales`
-- -----------------------------------------------------
START TRANSACTION;
USE `secretaria_administrativa`;
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Cemento');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Vidrio');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Ladrillo');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Clavos');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Tornillos');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Aluminio');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Zinc');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Cielo raso');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Cable de red');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Mosaicos');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Azulejos');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Puertas');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Bisagras');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Vitrina');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Proyector');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Cámara');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Pinzas');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Llave inglesa');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Lavamanos');
INSERT INTO `secretaria_administrativa`.`Materiales` (`idMateriales`, `nombre`) VALUES (DEFAULT, 'Tuberías');
